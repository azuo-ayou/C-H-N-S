function error = inf_norm_2D(solution,exact_solution_fun,Tb,T,P,basis_type,t)
...
for n=1:number_of_elements 
    ...
    %计算局部网格上的数值误差
    local_error=Guass_int_for_error_2D_inf_1(Gauss_weight,Gauss_point,exact_solution_fun,uh_local,vertices,basis_type,Tb,t);
...
function local_error=Guass_int_for_error_2D_inf_1(Gauss_weight,Gauss_point,exact_solution_fun,uh_local,vertices,basis_type,Tb,t)
...
for i=1:Gpn
   ...
   sum=sum+uh_local(j)*FE_local_basis_2D(Gauss_point(1,i),Gauss_point(2,i),vertices,basis_type,j,0,0);
    ...
    int_value=max(int_value,abs(feval(exact_solution_fun,Gauss_point(1,i),Gauss_point(2,i),t)-sum));
end
