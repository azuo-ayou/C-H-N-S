function A=J_and_phi_only_once(Exact_J,matrix_size,Pb,Tb,basis_type_trial,basis_type_test)
...
for k= 1 : Gpn
    ...
    for i = 1 : Gpn
        ...
        int_value1=int_value1+Gauss_weight(i)*feval(Exact_J,Gauss_point(1,k)-Gauss_point(1,i),Gauss_point(2,k)-Gauss_point(2,i))*(FE_local_basis_2D(Gauss_point(1,k),Gauss_point(2,k),vertices,basis_type_trial,basis_index_trial,0,0)-FE_local_basis_2D(Gauss_point(1,i),Gauss_point(2,i),vertices,basis_type_trial,basis_index_trial,0,0));
