function A=assemble_matrix_2D_sav(a,solution_n1,solution_n1_ex,matrix_size,Pb,Tb,basis_type_trial,der_trial_x,der_trial_y,basis_type_test,der_test_x,der_test_y,gram,type_scheme,beta1)
...
for n = 1 : number_of_element
    ...
    for alpha = 1 : number_of_local_basis
        for beta = 1 : number_of_local_basis 
            int_value =Gauss_vol_int_trial_test_sav(number_of_local_basis,a,uh_local1,uh_local2,Gauss_weight,Gauss_point,vertices,basis_type_trial,alpha,der_trial_x,der_trial_y,basis_type_test,beta,der_test_x,der_test_y,Gpn,gram,type_scheme,beta1);
...
function int_value = Gauss_vol_int_trial_test_sav(number_of_local_basis,a,uh_local1,uh_local2,Gauss_weight,Gauss_point,vertices,basis_type_trial,basis_index_trial,der_trial_x,der_trial_y,basis_type_test,basis_index_test,der_test_x,der_test_y,Gpn,gram,type_scheme,beta1)
int_value1=0;
int_value2=0;
for i = 1 : Gpn
    c1=0;
...
int_value1=int_value1+Gauss_weight(i)*gram*(c3^3-c3-beta1*c3)/a* FE_local_basis_2D(Gauss_point(1,i),Gauss_point(2,i),vertices,basis_type_trial,basis_index_trial,der_trial_x,der_trial_y);
int_value2=int_value2+Gauss_weight(i)*gram*(c3^3-c3-beta1*c3)/a* FE_local_basis_2D(Gauss_point(1,i),Gauss_point(2,i),vertices,basis_type_test,basis_index_test,der_test_x,der_test_y);
