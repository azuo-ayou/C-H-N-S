function b = assemble_vector_2D_sav_bn(rn,fb1,solution_n1_ex,matrix_size,Pb,Tb,basis_type_test,AN_der1_x,AN_der1_y,gram,type_scheme,beta)
...
for n = 1 : number_of_element
    ...
    for beta = 1 : number_of_local_basis
        int_value = Gauss_vol_int_f_bN(rn,uh_local_1,uh_local_2,number_of_local_basis,Gauss_weight,Gauss_point,vertices,basis_type_test,beta,Gpn,AN_der1_x,AN_der1_y,gram,type_scheme,beta);
        b(Tb(beta,n))=b(Tb(beta,n))+int_value;
    end
    
end

function int_value = Gauss_vol_int_f_bN(rn,uh_local_1,uh_local_2,number_of_local_basis,Gauss_weight,Gauss_point,vertices,basis_type_test,basis_index_test,Gpn,AN_der1_x,AN_der1_y,gram,type_scheme,beta)
int_value=0;
for i = 1 : Gpn
    c1=0;
     c2=0;
...
if type_scheme == 111
   ...
   elseif type_scheme == 333
     ...
     int_value=int_value+Gauss_weight(i)*gram*(c3^3-c3-beta*c3)/rn*(FE_local_basis_2D(Gauss_point(1,i),Gauss_point(2,i),vertices,basis_type_test,basis_index_test,0,0));
